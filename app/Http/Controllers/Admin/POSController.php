...
class POSController extends Controller
{
	        	...
	        	foreach($items as $k => $item){
		        	...
		        	if( $request->loai == 1 ){
			            ...
			            $data .= '<div class="container">
							<div class="row">
								<div class="col-xs-5"><h2 class="print-title">PHIẾU ĐỀ XUẤT</h2></div>
								<div class="col-xs-4">
							...
							<div class="row">
								<div class="col-xs-5">
									Hình thức thanh toán: '.@$this->_data['siteconfig'][$request->type]['site']['payment'][$item->payment_id].'
								</div>
								<div class="col-xs-7">
									<div class="row">
										<div class="col-xs-6">
							...
							<div class="row">
								<div class="col-xs-12">
									Yêu cầu thu cọc: <b>'.get_currency_vn($item->deposit_note,'').'</b><br>
								</div>
							</div>
							<br/>
							<div class="row">
			            ...
			            $data .= '<div class="container" style="padding-left: 60px">
									...
									<div class="row" style="font-size:15px">
										<div class="col-xs-7">Kho hàng: Vĩnh Lộc</div>
										<div class="col-xs-5">Mã đơn hàng: '.$item->code.'</div>
									</div>
									...
									<div class="row" style="font-size:15px">
										...
										<div class="col-xs-12">Giờ giao hàng: <b>'.$item->delivery_time.'</b></div>
									</div>
									<br>
						...
						$data .= '<div class="container">
							<div class="row" style="border-bottom:1px solid black">
								...
								<div class="col-xs-7">
									...
									<div>Mã số thuế: <b>0315626048</b></div>
									<div>Sieu thị: F1/7D Hương Lộ 80, Vĩnh Lộc A, H Bình Chánh, TP.HCM</div>
							...
							<div class="row">
		                        <div class="col-xs-12">
		                            <b>Số tiền Thu Cọc:</b> <span class="font-red-mint font-md bold">'.get_currency_vn($item->deposit_amount,'').'</span>
		                        </div>
							</div>
							<div class="row">
								<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<b>THANH TOÁN CỌC CHO SẢN PHẨM</b>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-12">
    ...
    public function store(Request $request){
        ...
        if ($valid->fails()) {
            ...
            return redirect()->route('admin.pos.index',['type'=>$this->_data['type']])->with('success','Thêm dữ liệu <b>'.$order->code.'</b> thành công');
        }
    ...
    public function show($id){
        ...
        return redirect()->route('admin.pos.index',['type'=>$this->_data['type']])->with('danger', 'Dữ liệu không tồn tại');
    }
    ...
    public function delete($id){
        ...
        if ($order !== null) {
            if( $order->delete() ){
                OrderDetail::whereIn('id',$order->details()->pluck('id')->toArray())->delete();
                return redirect()->route('admin.pos.index',['type'=>$this->_data['type']])->with('success', 'Xóa dữ liệu <b>'.$deleted.'</b> thành công');
            }else{
                return redirect()->route('admin.pos.index',['type'=>$this->_data['type']])->with('danger', 'Xóa dữ liệu bị lỗi');
            }
        }
        return redirect()->route('admin.pos.index',['type'=>$this->_data['type']])->with('danger', 'Dữ liệu không tồn tại');
    }
