...
<div class="row" id="qh-app">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="{{ route('admin.pos.update',['id'=>$item->id,'type'=>$type]) }}" class="form-validation">
        {{ csrf_field() }}
        {{ method_field('put') }}
        ...
        <div class="col-lg-9 col-xs-12">
                ...
                <div class="portlet-body">
                    <div class="form-group">
                        <div class="input-group select2-bootstrap-append">
                            ...
                            <span class="input-group-btn"> <button v-on:click="addProduct" type="button" id="btn-select" class="btn btn-info btn-lg"> Chọn </button> </span>
                        </div>
                    </div>
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[phone]" class="form-control validate[custom[phone],minSize[10],maxSize[10]]" value="{{ $item->phone }}">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    <p><button type="button" class="btn btn-same"> Lấy thông tin khách hàng </button></p>
                    <div class="form-group">
                        <label class="control-label"><i class="fa fa-phone" aria-hidden="true"></i> Điện thoại</label>
                            <div>
                                <input type="text" name="data[delivery][phone]" class="form-control validate[custom[phone],minSize[10],maxSize[10]]" value="{{ $item->delivery['phone'] }}">
                            </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><i class="fa fa-user" aria-hidden="true"></i> Họ và tên</label>
