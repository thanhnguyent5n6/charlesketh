...
@section('breadcrumb')
<li>
    <a href="{{ route('admin.price.index') }}"> Phiếu báo giá </a>
...
<div class="row" id="qh-app">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="{{ route('admin.price.update',['id'=>$item->id]) }}" class="form-validation">
        {{ csrf_field() }}
        {{ method_field('put') }}
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="data[phone]" class="form-control" value="{{ $item->phone }}" placeholder="0931.......">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><i class="fa fa-user" aria-hidden="true"></i> Họ và tên</label>
                        <div>
                            <input type="text" name="data[name]" class="form-control" value="{{ $item->name }}" placeholder="Nguyễn Văn A">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><i class="fa fa-map-marker" aria-hidden="true"></i> Địa chỉ</label>
                        <div>
                            <input type="text" name="data[address]" class="form-control" value="{{ $item->address }}" placeholder="Số 123 Trường Chinh.....">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><i class="fa fa-user" aria-hidden="true"></i> Email</label>
                        <div>
                            <input type="text" name="data[email]" class="form-control" value="{{ $item->email }}" placeholder="company@gmail.com">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <table class="table table-bordered table-condensed">
        ...
        <tbody>
            <tr v-for="(item, key) in products" >
                ...
                <td align="center"><div>@{{ formatPrice(subtotal[key]) }} </div></td>
