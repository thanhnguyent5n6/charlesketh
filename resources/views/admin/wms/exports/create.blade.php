                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <select name="data[store_code]" class="selectpicker show-tick show-menu-arrow form-control">
                                ...
                                <option value="{{ $warehouse->code }}" {{ Request::query('store') == $warehouse->code ? 'selected' : '' }} > {{ $warehouse->name }} </option>
                                @empty
                                @endforelse
                            </select>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('select[name="data[store_code]"]').on('change', function(){
            location.href = window.Laravel.baseUrl + '/admin/wms_exports/create?type=default&store=' + $(this).val();
        })
    })
    new Vue({
        el: '#qh-app',
