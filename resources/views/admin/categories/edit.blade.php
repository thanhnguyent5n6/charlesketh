        ...
        <div class="col-lg-3 col-xs-12">
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group" data="{{ $item->suppliers }}" >
                        <label class="control-label">Nhà cung cấp</label>
                        <div>
                            <select class="selectpicker show-tick show-menu-arrow form-control" name="suppliers[]" multiple>
                                @foreach($suppliers as $key => $val)
                                <option value="{{ $val->id }}" {{ in_array($val->id,explode(',',$item->suppliers)) ? 'selected' : '' }} > {{ $val->name }} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group" data="{{ $item->filters }}" >
                        ...
                        <div>
                            <select class="selectpicker show-tick show-menu-arrow form-control" name="filters[]" multiple>
                                ...
                                <option value="{{ $val->id }}" {{ in_array($val->id,explode(',',$item->filters)) ? 'selected' : '' }} > {{ $val->title }} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
