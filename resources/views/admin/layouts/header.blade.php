    ...
    <div class="page-header-inner ">
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li><a href="https://sslock.vn/admin/pos/create?type=shop" class="order-si" title="đơn hàng"><i class="fa fa-plus" aria-hidden="true"></i> <span class="hidden-xs">TẠO ĐƠN HÀNG</span></a></li>
                <li><a href="{{ route('admin.order.export', ['type' => 'shop', 'extension'=>'xlsx'] ) }}" class="order-si" title="đơn hàng" style="margin-left: 5px">
                    <i class="fa fa-bar-chart"></i> <span class="hidden-xs">Xuất File Báo Cáo</span></a></li>
                @elseif( check_role('wholesale') )
                <li><a href="https://sslock.vn/admin/orders/create?type=wholesale" class="order-si" title="đơn hàng"><i class="fa fa-plus" aria-hidden="true"></i> <span class="hidden-xs">TẠO ĐƠN HÀNG SỈ</span></a></li>
                @endif

                <?php /*
                
                @if ( Auth::user()->hasRole('admin') || @Auth::user()->groups()->first()->id == 5 )
                <li><a href="{{ route('admin.order.export', ['type' => 'shop', 'extension'=>'xlsx'] ) }}" class="order-si" title="đơn hàng">
                    <i class="fa fa-bar-chart"></i> <span class="hidden-xs">Xuất File Báo Cáo</span></a></li>
                @endif
                ...
                */ ?>
                ...
                <li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
                    ...
                    <ul class="dropdown-menu">
                        <li class="external">
                            <h3>Bạn có
                                <span class="bold">7 tin</span> Thông Báo</h3>
                            ...
                            <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="subject">
                                            <span class="from"> Thu Thảo </span>
                                            <span class="time">mới đây </span>
                                        </span>
                                        <span class="message"> Chưa hoàn thành KPI hằng ngày </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
