...
<div class="row" id="qh-app">
    ...
    <form role="form" method="POST" action="{{ route('admin.order.store',['type'=>$type]) }}" class="form-validation">
        ...
        <div class="col-lg-9 col-xs-12"> 
            ...
            <div class="portlet box green form_oder">
                <div class="portlet-title">
                    <div class="caption"> Nhập Thông Tin Khách hàng </div>
                </div>
                <div class="portlet-body">
                    <div class="form-group">
                        <label class="control-label">Điện thoại của khách hàng</label>
                            <div>
                                <input type="text" name="data[phone]" class="form-control validate[required,custom[phone],minSize[10],maxSize[10]]" value="{{ old('data.phone') }}" placeholder="0931.......">
                            </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group datetimepicker">
                            <input type="text" class="form-control" readonly="" name="delivery_time" value="{{ old('delivery_time') }}">
                    ...
                    <button type="button" class="btn btn-invoice bg-success"> Xuất hóa đơn (nếu có) </button>
            ...
            <div class="portlet box green orm_oder form_oder">
                <div class="portlet-title">
                    <div class="caption"> Thông Tin Người Nhận hàng </div>
                </div>
                <div class="portlet-body">
                    <p><button type="button" class="btn btn-same btn-success"> Copy thông tin khách hàng phía trên </button></p>
                    <div class="form-group">
                        <label class="control-label"><i class="fa fa-phone" aria-hidden="true"></i> Điện thoại</label>
                            <div>
                                <input type="text" name="data[delivery][phone]" class="form-control validate[required,custom[phone],minSize[10],maxSize[10]]" value="{{ old('data.phone') }}" placeholder="0931.......">
                            </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><i class="fa fa-user" aria-hidden="true"></i> Họ và tên</label>
                        <div>
                            <input type="text" name="data[delivery][name]" class="form-control" value="{{ old('data.delivery.name') }}" placeholder="Nguyễn văn A">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label"><i class="fa fa-map-marker" aria-hidden="true"></i> Địa chỉ</label>
                        <div>
                            <input type="text" name="data[delivery][address]" class="form-control" value="{{ old('data.delivery.address') }}" placeholder="Số 123 trường chinh .....">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6">
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="enhancement" class="form-control" value="{{ old('enhancement') }}" v-model.number="enhancement">
                            <span class="input-group-addon"> Đ </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="deposit_note" class="form-control priceFormat">
                            <span class="input-group-addon"> Đ </span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label">Phí vật tư</label>
                        <div class="input-group">
    ...
    <table class="table table-bordered table-condensed">
        ...
        <tbody>
            <tr v-for="(item, key) in products" >
                ...
                <td align="center">@{{ formatPrice(subtotal[key]) }}<input type="text" :name="'products['+ key +'][price_discount]'" class="form-control text-center" placeholder="Giảm giá" v-model.formatPrice="item.price_discount"></td>
