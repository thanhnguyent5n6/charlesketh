    ...
    <div class="col-lg-3 col-xs-12">
        <div class="portlet box green">
            ...
            <div class="portlet-body">
                ...
                <div class="form-group">
                            <label class="mt-checkbox">Thi công
                                <input type="checkbox" name="status[]" value="construction" {{ (strpos($item->status,'construction') !== false)?'checked':'' }} > <span></span> </label>
                            <input type="hidden" name="status[]" value="publish" {{ (strpos($item->status,'publish') !== false)?'checked':'' }}>
                    </div>
