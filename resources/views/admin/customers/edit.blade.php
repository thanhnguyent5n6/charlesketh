...
@section('breadcrumb')
<li>
    <a href="{{ route('admin.customer.index',['type'=>$type]) }}"> {{ $pageTitle }} </a>
...
<div class="row">
    ...
    <!-- BEGIN FORM-->
    <form role="form" method="POST" action="{{ route('admin.customer.update',['id'=>$item->id, 'type'=>$type]) }}" >
        {{ csrf_field() }}
        {{ method_field('put') }}
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="point" class="form-control priceFormat" value="{{ $item->point }}" readonly="">
                        </div>
                    </div>
